...
1. Запустите backend:
   ...
   ```
2. Откройте браузер по адресу `http://127.0.0.1:8000/app/`.

На странице:
- слева — фильтры и лента карточек,
- справа — выбранная карточка и чат-заглушка,
- отдельная вкладка — реестр карточек в табличном виде.
